...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:205
...
public abstract class AssignAdditiveExpr extends AssignExpr implements Cloneable {
   ...
   * @apilevel high-level
   */
  public AssignAdditiveExpr setDest(Expr node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public AssignAdditiveExpr setSource(Expr node) {
    setChild(node, 1);
    return this;
  }
  /**
