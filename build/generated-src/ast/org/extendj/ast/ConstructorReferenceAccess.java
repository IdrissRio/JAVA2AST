...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/grammar/ConstructorReference.ast:5
...
public class ConstructorReferenceAccess extends ClassInstanceExpr implements Cloneable {
  /**
   * @aspect Synthetics
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/MethodReference.jrag:446
   */
  private FunctionDescriptor targetDescriptor;
  /**
   * @aspect Synthetics
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/MethodReference.jrag:447
   */
   ...
   * @apilevel high-level
   */
  public ConstructorReferenceAccess setAccess(Access node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorReferenceAccess setArgList(List<Expr> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorReferenceAccess addArg(Expr node) {
  ...
  /** @apilevel low-level 
   */
  public ConstructorReferenceAccess addArgNoTransform(Expr node) {
   ...
   * @apilevel high-level
   */
  public ConstructorReferenceAccess setArg(Expr node, int i) {
   ...
   * @apilevel low-level
   */
  public ConstructorReferenceAccess setTypeDeclOpt(Opt<TypeDecl> opt) {
    setChild(opt, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorReferenceAccess setTypeDecl(TypeDecl node) {
   ...
   * @attribute syn
   * @aspect TargetType
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/TargetType.jrag:207
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TargetType", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/TargetType.jrag:207")
