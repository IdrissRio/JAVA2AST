...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:149
 * @astdecl FloatingPointType : NumericType ::= Modifiers <ID:String> [SuperClass:Access] BodyDecl*;
...
public class FloatingPointType extends NumericType implements Cloneable {
   ...
   * @apilevel high-level
   */
  public FloatingPointType setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public FloatingPointType setID(String value) {
   ...
   * @apilevel internal
   */
  public FloatingPointType setID(beaver.Symbol symbol) {
   ...
   * @apilevel low-level
   */
  public FloatingPointType setSuperClassOpt(Opt<Access> opt) {
    setChild(opt, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public FloatingPointType setSuperClass(Access node) {
   ...
   * @apilevel high-level
   */
  public FloatingPointType setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public FloatingPointType addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public FloatingPointType addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public FloatingPointType setBodyDecl(BodyDecl node, int i) {
