 ...
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:112
...
public class GenericClassDeclErased extends GenericClassDeclSubstituted implements Cloneable {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setID(String value) {
   ...
   * @apilevel internal
   */
  public GenericClassDeclErased setID(beaver.Symbol symbol) {
   ...
   * @apilevel low-level
   */
  public GenericClassDeclErased setSuperClassOpt(Opt<Access> opt) {
    setChild(opt, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setSuperClass(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setImplementsList(List<Access> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased addImplements(Access node) {
  ...
  /** @apilevel low-level 
   */
  public GenericClassDeclErased addImplementsNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setImplements(Access node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public GenericClassDeclErased addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setOriginal(TypeDecl value) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setImplicitConstructor(ConstructorDecl node) {
   ...
   * @apilevel internal
   */
  public GenericClassDeclErased setBodyDeclList(List<BodyDecl> node) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public GenericClassDeclErased addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public GenericClassDeclErased setBodyDecl(BodyDecl node, int i) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1691
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="LookupParTypeDecl", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1691")
