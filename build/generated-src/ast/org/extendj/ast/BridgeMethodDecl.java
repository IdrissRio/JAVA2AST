...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:125
...
public class BridgeMethodDecl extends MethodDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setTypeAccess(Access node) {
    setChild(node, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setID(String value) {
   ...
   * @apilevel internal
   */
  public BridgeMethodDecl setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public BridgeMethodDecl addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setExceptionList(List<Access> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public BridgeMethodDecl addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public BridgeMethodDecl setBlockOpt(Opt<Block> opt) {
    setChild(opt, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public BridgeMethodDecl setBlock(Block node) {
