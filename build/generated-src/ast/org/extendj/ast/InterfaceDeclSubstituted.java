...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:99
 * @astdecl InterfaceDeclSubstituted : InterfaceDecl ::= Modifiers <ID:String> SuperInterface:Access* BodyDecl* <Original:TypeDecl>;
 * @production InterfaceDeclSubstituted : {@link InterfaceDecl} ::= <span class="component">&lt;Original:{@link TypeDecl}&gt;</span>;
...
public class InterfaceDeclSubstituted extends InterfaceDecl implements Cloneable, MemberSubstitutor {
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted setID(String value) {
   ...
   * @apilevel internal
   */
  public InterfaceDeclSubstituted setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted setSuperInterfaceList(List<Access> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted addSuperInterface(Access node) {
  ...
  /** @apilevel low-level 
   */
  public InterfaceDeclSubstituted addSuperInterfaceNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted setSuperInterface(Access node, int i) {
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public InterfaceDeclSubstituted addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted setBodyDecl(BodyDecl node, int i) {
   ...
   * @apilevel high-level
   */
  public InterfaceDeclSubstituted setOriginal(TypeDecl value) {
   ...
   * @attribute syn
   * @aspect Generics
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:88
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1682
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1905
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericsSubtype.jrag:593
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericsSubtype.jrag:615
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericsSubtype.jrag:619
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/GenericsSubtype.jrag:473
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect StrictSubtype
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/GenericsSubtype.jrag:478
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
