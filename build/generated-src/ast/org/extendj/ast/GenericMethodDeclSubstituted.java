...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:78
 ...
 * @production GenericMethodDeclSubstituted : {@link GenericMethodDecl} ::= <span class="component">&lt;Original:{@link GenericMethodDecl}&gt;</span>;
...
public class GenericMethodDeclSubstituted extends GenericMethodDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setTypeAccess(Access node) {
    setChild(node, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setID(String value) {
   ...
   * @apilevel internal
   */
  public GenericMethodDeclSubstituted setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public GenericMethodDeclSubstituted addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setExceptionList(List<Access> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public GenericMethodDeclSubstituted addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public GenericMethodDeclSubstituted setBlockOpt(Opt<Block> opt) {
    setChild(opt, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setBlock(Block node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public GenericMethodDeclSubstituted addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclSubstituted setOriginal(GenericMethodDecl value) {
