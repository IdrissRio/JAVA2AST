...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:114
 ...
 * @production GenericInterfaceDeclSubstituted : {@link GenericInterfaceDecl} ::= <span class="component">&lt;Original:{@link TypeDecl}&gt;</span>;
...
public class GenericInterfaceDeclSubstituted extends GenericInterfaceDecl implements Cloneable, MemberSubstitutor {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setID(String value) {
   ...
   * @apilevel internal
   */
  public GenericInterfaceDeclSubstituted setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setSuperInterfaceList(List<Access> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted addSuperInterface(Access node) {
  ...
  /** @apilevel low-level 
   */
  public GenericInterfaceDeclSubstituted addSuperInterfaceNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setSuperInterface(Access node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public GenericInterfaceDeclSubstituted addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setBodyDecl(BodyDecl node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public GenericInterfaceDeclSubstituted addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericInterfaceDeclSubstituted setOriginal(TypeDecl value) {
   ...
   * @attribute syn
   * @aspect Generics
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:90
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1684
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1907
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericsSubtype.jrag:595
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericsSubtype.jrag:643
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericsSubtype.jrag:648
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/GenericsSubtype.jrag:500
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect StrictSubtype
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/GenericsSubtype.jrag:504
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
