...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:198
...
public class AssignSimpleExpr extends AssignExpr implements Cloneable {
   ...
   * @apilevel high-level
   */
  public AssignSimpleExpr setDest(Expr node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public AssignSimpleExpr setSource(Expr node) {
    setChild(node, 1);
    return this;
  }
  /**
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/PrettyPrintUtil.jrag:376
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java7/frontend/SuppressWarnings.jrag:36
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="SuppressWarnings", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java7/frontend/SuppressWarnings.jrag:36")
  ...
  public boolean Define_isDest(ASTNode _callerNode, ASTNode _childNode) {
    if (getDestNoTransform() != null && _callerNode == getDest()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/DefiniteAssignment.jrag:36
      return true;
    }
    else {
  ...
  public boolean Define_isSource(ASTNode _callerNode, ASTNode _childNode) {
    if (getDestNoTransform() != null && _callerNode == getDest()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/DefiniteAssignment.jrag:46
      return false;
    }
    else {
  ...
  public TypeDecl Define_assignConvertedType(ASTNode _callerNode, ASTNode _childNode) {
    if (getSourceNoTransform() != null && _callerNode == getSource()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethodsInference.jrag:71
      return getDest().type();
    }
    else {
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java7/frontend/UncheckedConversion.jrag:51
