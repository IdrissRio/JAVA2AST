...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:77
 ...
 * @production MethodDeclSubstituted : {@link MethodDecl} ::= <span class="component">&lt;Original:{@link MethodDecl}&gt;</span>;
...
public class MethodDeclSubstituted extends MethodDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setTypeAccess(Access node) {
    setChild(node, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setID(String value) {
   ...
   * @apilevel internal
   */
  public MethodDeclSubstituted setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public MethodDeclSubstituted addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setExceptionList(List<Access> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public MethodDeclSubstituted addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public MethodDeclSubstituted setBlockOpt(Opt<Block> opt) {
    setChild(opt, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setBlock(Block node) {
   ...
   * @apilevel high-level
   */
  public MethodDeclSubstituted setOriginal(MethodDecl value) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1676
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1911
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/MethodSignature.jrag:453
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect LambdaParametersInference
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/TypeCheck.jrag:567
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
