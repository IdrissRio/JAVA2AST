...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Annotations.ast:2
...
public class AnnotationDecl extends InterfaceDecl implements Cloneable {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/PrettyPrint.jadd:49
   */
   ...
   * @apilevel high-level
   */
  public AnnotationDecl setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public AnnotationDecl setID(String value) {
   ...
   * @apilevel internal
   */
  public AnnotationDecl setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public AnnotationDecl setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public AnnotationDecl addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public AnnotationDecl addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public AnnotationDecl setBodyDecl(BodyDecl node, int i) {
   ...
   * @apilevel internal
   */
  public AnnotationDecl setSuperInterfaceList(List<Access> node) {
   ...
   * @apilevel high-level
   */
  public AnnotationDecl addSuperInterface(Access node) {
  ...
  /** @apilevel low-level 
   */
  public AnnotationDecl addSuperInterfaceNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public AnnotationDecl setSuperInterface(Access node, int i) {
   ...
   * @attribute syn nta
   * @aspect Annotations
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:170
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="Annotations", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:170")
   ...
   * @attribute syn
   * @aspect Annotations
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:176
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="Annotations", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:176")
   ...
   * @attribute syn
   * @aspect Annotations
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:226
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  @ASTNodeAnnotation.Source(aspect="Annotations", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:236")
   ...
   * @attribute syn
   * @aspect Annotations
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:773
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean Define_mayUseAnnotationTarget(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (getModifiersNoTransform() != null && _callerNode == getModifiers()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:141
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Annotations.jrag:174
    {
