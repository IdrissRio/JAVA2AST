...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:79
 ...
 * @production GenericMethodDeclErased : {@link GenericMethodDecl} ::= <span class="component">&lt;Original:{@link GenericMethodDecl}&gt;</span>;
...
public class GenericMethodDeclErased extends GenericMethodDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setTypeAccess(Access node) {
    setChild(node, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setID(String value) {
   ...
   * @apilevel internal
   */
  public GenericMethodDeclErased setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public GenericMethodDeclErased addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setExceptionList(List<Access> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public GenericMethodDeclErased addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public GenericMethodDeclErased setBlockOpt(Opt<Block> opt) {
    setChild(opt, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setBlock(Block node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public GenericMethodDeclErased addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericMethodDeclErased setOriginal(GenericMethodDecl value) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:66
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="GenericMethods", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:66")
