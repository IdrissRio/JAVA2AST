...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/GenericMethods.ast:15
...
public class RawConstructorDecl extends ParConstructorDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setID(String value) {
   ...
   * @apilevel internal
   */
  public RawConstructorDecl setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public RawConstructorDecl addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setExceptionList(List<Access> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public RawConstructorDecl addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public RawConstructorDecl setParsedConstructorInvocationOpt(Opt<Stmt> opt) {
    setChild(opt, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setParsedConstructorInvocation(Stmt node) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setBlock(Block node) {
    setChild(node, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setTypeArgumentList(List<Access> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl addTypeArgument(Access node) {
  ...
  /** @apilevel low-level 
   */
  public RawConstructorDecl addTypeArgumentNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setTypeArgument(Access node, int i) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setGenericConstructorDecl(GenericConstructorDecl value) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 6);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public RawConstructorDecl addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public RawConstructorDecl setParameterization(Parameterization value) {
