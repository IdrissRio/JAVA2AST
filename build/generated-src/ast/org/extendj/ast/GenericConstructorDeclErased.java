...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:82
 ...
 * @production GenericConstructorDeclErased : {@link GenericConstructorDecl} ::= <span class="component">&lt;Original:{@link GenericConstructorDecl}&gt;</span>;
...
public class GenericConstructorDeclErased extends GenericConstructorDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setID(String value) {
   ...
   * @apilevel internal
   */
  public GenericConstructorDeclErased setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDeclErased addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setExceptionList(List<Access> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDeclErased addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public GenericConstructorDeclErased setParsedConstructorInvocationOpt(Opt<Stmt> opt) {
    setChild(opt, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setParsedConstructorInvocation(Stmt node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setBlock(Block node) {
    setChild(node, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDeclErased addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclErased setOriginal(GenericConstructorDecl value) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:105
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="GenericMethods", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:105")
