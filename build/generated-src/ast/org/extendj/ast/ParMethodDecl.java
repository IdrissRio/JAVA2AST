...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/GenericMethods.ast:4
 ...
 * @production ParMethodDecl : {@link MethodDecl} ::= <span class="component">TypeArgument:{@link Access}*</span> <span class="component">&lt;GenericMethodDecl:{@link GenericMethodDecl}&gt;</span> <span class="component">TypeParameter:{@link TypeVariable}*</span> <span class="component">&lt;Parameterization:{@link Parameterization}&gt;</span>;

 */
public class ParMethodDecl extends MethodDecl implements Cloneable {
  /**
   * @aspect LookupParTypeDecl
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1281
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1289
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/PrettyPrintUtil.jrag:46
   */
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setTypeAccess(Access node) {
    setChild(node, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setID(String value) {
   ...
   * @apilevel internal
   */
  public ParMethodDecl setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ParMethodDecl addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public ParMethodDecl addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setExceptionList(List<Access> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ParMethodDecl addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public ParMethodDecl addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public ParMethodDecl setBlockOpt(Opt<Block> opt) {
    setChild(opt, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setBlock(Block node) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setTypeArgumentList(List<Access> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ParMethodDecl addTypeArgument(Access node) {
  ...
  /** @apilevel low-level 
   */
  public ParMethodDecl addTypeArgumentNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setTypeArgument(Access node, int i) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setGenericMethodDecl(GenericMethodDecl value) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 6);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ParMethodDecl addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public ParMethodDecl addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public ParMethodDecl setParameterization(Parameterization value) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:52
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="GenericMethods", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:52")
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1678
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1910
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/MethodSignature.jrag:190
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
