...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:141
 * @astdecl NumericType : PrimitiveType ::= Modifiers <ID:String> [SuperClass:Access] BodyDecl*;
...
public abstract class NumericType extends PrimitiveType implements Cloneable {
   ...
   * @apilevel high-level
   */
  public NumericType setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public NumericType setID(String value) {
   ...
   * @apilevel internal
   */
  public NumericType setID(beaver.Symbol symbol) {
   ...
   * @apilevel low-level
   */
  public NumericType setSuperClassOpt(Opt<Access> opt) {
    setChild(opt, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public NumericType setSuperClass(Access node) {
   ...
   * @apilevel high-level
   */
  public NumericType setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public NumericType addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public NumericType addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public NumericType setBodyDecl(BodyDecl node, int i) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/TypeAnalysis.jrag:167
   */
  private TypeDecl refined_NumericPromotion_NumericType_binaryNumericPromotion_TypeDecl(TypeDecl type)
{
   ...
   * @attribute syn
   * @aspect NumericPromotion
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/TypeAnalysis.jrag:159
   */
   ...
   * @attribute syn
   * @aspect AutoBoxing
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/AutoBoxing.jrag:243
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NumericPromotion", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/TypeAnalysis.jrag:167")
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/TypeAnalysis.jrag:187
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
