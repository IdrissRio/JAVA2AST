...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/GenericMethods.ast:2
...
public class GenericConstructorDecl extends ConstructorDecl implements Cloneable {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/PrettyPrint.jadd:191
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:109
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1475
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1572
   */
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setID(String value) {
   ...
   * @apilevel internal
   */
  public GenericConstructorDecl setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDecl addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setExceptionList(List<Access> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDecl addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public GenericConstructorDecl setParsedConstructorInvocationOpt(Opt<Stmt> opt) {
    setChild(opt, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setParsedConstructorInvocation(Stmt node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setBlock(Block node) {
    setChild(node, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDecl addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDecl setTypeParameter(TypeVariable node, int i) {
   ...
   * @attribute syn
   * @aspect GenericMethods
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:101
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="GenericMethods", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:101")
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:233
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="GenericMethodsNameAnalysis", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:233")
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1462
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="LookupParTypeDecl", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1462")
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/MethodSignature.jrag:417
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect MethodSignature15
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/MethodSignature.jrag:439
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect MethodSignature15
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/MethodSignature.jrag:454
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  @ASTNodeAnnotation.Source(aspect="GenericMethodsNameAnalysis", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:231")
  ...
  public NameType Define_nameType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeParameterListNoTransform()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/GenericMethods.jrag:229
