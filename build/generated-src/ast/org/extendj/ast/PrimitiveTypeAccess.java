...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:93
 * @astdecl PrimitiveTypeAccess : TypeAccess ::= <Package:String> <ID:String>;
 * @production PrimitiveTypeAccess : {@link TypeAccess} ::= <span class="component">&lt;Package:{@link String}&gt;</span> <span class="component">&lt;ID:{@link String}&gt;</span>;

 */
public class PrimitiveTypeAccess extends TypeAccess implements Cloneable {
  /**
   * @aspect NodeConstructors
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/NodeConstructors.jrag:92
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/PrettyPrintUtil.jrag:75
   */
   ...
   * @apilevel high-level
   */
  public PrimitiveTypeAccess setPackage(String value) {
   ...
   * @apilevel internal
   */
  public PrimitiveTypeAccess setPackage(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public PrimitiveTypeAccess setID(String value) {
   ...
   * @apilevel internal
   */
  public PrimitiveTypeAccess setID(beaver.Symbol symbol) {
    if (symbol.value != null && !(symbol.value instanceof String))
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/LookupType.jrag:357
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeScopePropagation", declaredAt="/Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/LookupType.jrag:357")
