 ...
 * expressions.
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:133
 * @astdecl EmptyType : PrimitiveType ::= Modifiers <ID:String> [SuperClass:Access] BodyDecl*;
...
public class EmptyType extends PrimitiveType implements Cloneable {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/PrettyPrint.jadd:356
   */
   ...
   */
  public EmptyType treeCopyNoTransform() {
   ...
   * @apilevel high-level
   */
  public EmptyType setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public EmptyType setID(String value) {
   ...
   * @apilevel internal
   */
  public EmptyType setID(beaver.Symbol symbol) {
   ...
   * @apilevel low-level
   */
  public EmptyType setSuperClassOpt(Opt<Access> opt) {
    setChild(opt, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public EmptyType setSuperClass(Access node) {
   ...
   * @apilevel high-level
   */
  public EmptyType setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public EmptyType addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public EmptyType addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public EmptyType setBodyDecl(BodyDecl node, int i) {
