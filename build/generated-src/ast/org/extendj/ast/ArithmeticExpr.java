...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:242
...
public abstract class ArithmeticExpr extends Binary implements Cloneable {
   ...
   * @apilevel high-level
   */
  public ArithmeticExpr setLeftOperand(Expr node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ArithmeticExpr setRightOperand(Expr node) {
    setChild(node, 1);
    return this;
  }
  /**
  ...
  public TypeDecl Define_targetType(ASTNode _callerNode, ASTNode _childNode) {
    if (getRightOperandNoTransform() != null && _callerNode == getRightOperand()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/TargetType.jrag:72
      {
      ...
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/TargetType.jrag:64
      {
          if (!getLeftOperand().isPolyExpression() && !getRightOperand().isPolyExpression()) {
            return type();
          } else {
  ...
  public boolean Define_numericContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getLeftOperandNoTransform() != null && _callerNode == getLeftOperand()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/TargetType.jrag:283
      return true;
    }
    else if (getRightOperandNoTransform() != null && _callerNode == getRightOperand()) {
      // @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java8/frontend/TargetType.jrag:282
      return true;
    }
    else {
