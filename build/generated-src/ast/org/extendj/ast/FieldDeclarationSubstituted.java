...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:84
 * @astdecl FieldDeclarationSubstituted : FieldDeclarator ::= <ID:String> Dims* [Init:Expr] <Original:FieldDeclarator> TypeAccess:Access;
 * @production FieldDeclarationSubstituted : {@link FieldDeclarator} ::= <span class="component">&lt;Original:{@link FieldDeclarator}&gt;</span>;
...
public class FieldDeclarationSubstituted extends FieldDeclarator implements Cloneable {
   ...
   * @apilevel high-level
   */
  public FieldDeclarationSubstituted setID(String value) {
   ...
   * @apilevel internal
   */
  public FieldDeclarationSubstituted setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public FieldDeclarationSubstituted setDimsList(List<Dims> list) {
    setChild(list, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public FieldDeclarationSubstituted addDims(Dims node) {
  ...
  /** @apilevel low-level 
   */
  public FieldDeclarationSubstituted addDimsNoTransform(Dims node) {
   ...
   * @apilevel high-level
   */
  public FieldDeclarationSubstituted setDims(Dims node, int i) {
   ...
   * @apilevel low-level
   */
  public FieldDeclarationSubstituted setInitOpt(Opt<Expr> opt) {
    setChild(opt, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public FieldDeclarationSubstituted setInit(Expr node) {
   ...
   * @apilevel high-level
   */
  public FieldDeclarationSubstituted setOriginal(FieldDeclarator value) {
