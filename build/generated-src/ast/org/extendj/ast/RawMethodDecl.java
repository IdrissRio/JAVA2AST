...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/GenericMethods.ast:8
...
public class RawMethodDecl extends ParMethodDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setTypeAccess(Access node) {
    setChild(node, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setID(String value) {
   ...
   * @apilevel internal
   */
  public RawMethodDecl setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawMethodDecl addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public RawMethodDecl addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setExceptionList(List<Access> list) {
    setChild(list, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawMethodDecl addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public RawMethodDecl addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public RawMethodDecl setBlockOpt(Opt<Block> opt) {
    setChild(opt, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setBlock(Block node) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setTypeArgumentList(List<Access> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawMethodDecl addTypeArgument(Access node) {
  ...
  /** @apilevel low-level 
   */
  public RawMethodDecl addTypeArgumentNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setTypeArgument(Access node, int i) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setGenericMethodDecl(GenericMethodDecl value) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 6);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public RawMethodDecl addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public RawMethodDecl addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public RawMethodDecl setParameterization(Parameterization value) {
