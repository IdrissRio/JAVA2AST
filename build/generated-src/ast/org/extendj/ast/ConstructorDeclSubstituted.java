...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:80
 ...
 * @production ConstructorDeclSubstituted : {@link ConstructorDecl} ::= <span class="component">&lt;Original:{@link ConstructorDecl}&gt;</span>;
...
public class ConstructorDeclSubstituted extends ConstructorDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setID(String value) {
   ...
   * @apilevel internal
   */
  public ConstructorDeclSubstituted setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public ConstructorDeclSubstituted addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setExceptionList(List<Access> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public ConstructorDeclSubstituted addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public ConstructorDeclSubstituted setParsedConstructorInvocationOpt(Opt<Stmt> opt) {
    setChild(opt, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setParsedConstructorInvocation(Stmt node) {
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setBlock(Block node) {
    setChild(node, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public ConstructorDeclSubstituted setOriginal(ConstructorDecl value) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/Generics.jrag:1918
   */
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/MethodSignature.jrag:455
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
