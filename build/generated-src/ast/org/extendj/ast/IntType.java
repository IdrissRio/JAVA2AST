...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:146
 * @astdecl IntType : IntegralType ::= Modifiers <ID:String> [SuperClass:Access] BodyDecl*;
...
public class IntType extends IntegralType implements Cloneable {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/PrettyPrint.jadd:399
   */
   ...
   * @apilevel high-level
   */
  public IntType setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public IntType setID(String value) {
   ...
   * @apilevel internal
   */
  public IntType setID(beaver.Symbol symbol) {
   ...
   * @apilevel low-level
   */
  public IntType setSuperClassOpt(Opt<Access> opt) {
    setChild(opt, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public IntType setSuperClass(Access node) {
   ...
   * @apilevel high-level
   */
  public IntType setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public IntType addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public IntType addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public IntType setBodyDecl(BodyDecl node, int i) {
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/frontend/TypeAnalysis.jrag:205
   */
   ...
   * @attribute syn
   * @aspect AutoBoxing
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/AutoBoxing.jrag:63
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
