...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/grammar/Generics.ast:81
 ...
 * @production GenericConstructorDeclSubstituted : {@link GenericConstructorDecl} ::= <span class="component">&lt;Original:{@link GenericConstructorDecl}&gt;</span>;
...
public class GenericConstructorDeclSubstituted extends GenericConstructorDecl implements Cloneable {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setID(String value) {
   ...
   * @apilevel internal
   */
  public GenericConstructorDeclSubstituted setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setParameterList(List<ParameterDeclaration> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted addParameter(ParameterDeclaration node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDeclSubstituted addParameterNoTransform(ParameterDeclaration node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setParameter(ParameterDeclaration node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setExceptionList(List<Access> list) {
    setChild(list, 2);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted addException(Access node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDeclSubstituted addExceptionNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setException(Access node, int i) {
   ...
   * @apilevel low-level
   */
  public GenericConstructorDeclSubstituted setParsedConstructorInvocationOpt(Opt<Stmt> opt) {
    setChild(opt, 3);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setParsedConstructorInvocation(Stmt node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setBlock(Block node) {
    setChild(node, 4);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setTypeParameterList(List<TypeVariable> list) {
    setChild(list, 5);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted addTypeParameter(TypeVariable node) {
  ...
  /** @apilevel low-level 
   */
  public GenericConstructorDeclSubstituted addTypeParameterNoTransform(TypeVariable node) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setTypeParameter(TypeVariable node, int i) {
   ...
   * @apilevel high-level
   */
  public GenericConstructorDeclSubstituted setOriginal(GenericConstructorDecl value) {
   ...
   * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java5/frontend/MethodSignature.jrag:441
   */
