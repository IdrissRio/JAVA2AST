...
/**
 * @ast node
 * @declaredat /Users/idrissr/phd/git/lund/research/artifacts/Composable-Software-Tools/JAVA2AST/extendj/java4/grammar/Java.ast:271
...
public abstract class EqualityExpr extends RelationalExpr implements Cloneable {
   ...
   * @apilevel high-level
   */
  public EqualityExpr setLeftOperand(Expr node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public EqualityExpr setRightOperand(Expr node) {
    setChild(node, 1);
    return this;
  }
  /**
